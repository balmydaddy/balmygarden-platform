          ...
          return (
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                fontSize: "12px",
                background: on ? (ceo ? "#fef3c7" : "#dcfce7") : "#f1f5f9",
                border: `1px solid ${on ? (ceo ? "#f59e0b" : "#22c55e") : "#e2e8f0"}`,
                color: "#94a3b8",
                fontFamily: "inherit",
              }}
            >
      ...
      {hit && (
        <div
          style={{
            ...
            padding: "10px 12px",
            borderRadius: "8px",
            background: hit.auth === "CEO" ? "#fef3c7" : "#dcfce7",
        ...
        >
          ...
          <div style={{ fontSize: "11px", color: "#64748b", marginTop: "3px" }}>{hit.why}</div>
        </div>
      )}
    </div>
  );
...
function RfsPanel() {
  ...
  return (
    <div style={card(blocked ? "#7f1d1d" : "#e2e8f0")}>
        ...
        {RFS_ITEMS.map((i) => (
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              fontSize: "12px",
              background: on[i.id] ? "#fef2f2" : "#f1f5f9",
              border: `1px solid ${on[i.id] ? "#ef4444" : "#e2e8f0"}`,
      ...
      <div
        style={{
          ...
          padding: "10px 12px",
          borderRadius: "8px",
          background: blocked ? "#fef2f2" : "#f1f5f9",
          border: `1px solid ${blocked ? "#ef4444" : "#e2e8f0"}`,
          fontSize: "12px",
          color: blocked ? "#fca5a5" : "#475569",
        ...
        <div key={s.area} style={{ marginBottom: "8px" }}>
          <button
            ...
            style={{
              ...
              fontSize: "12px",
              background: "#f1f5f9",
              border: `1px solid ${open === s.area ? "#6366F1" : "#e2e8f0"}`,
              color: "#94a3b8",
              fontFamily: "inherit",
            }}
          >
          ...
          {open === s.area && (
            <div style={{ padding: "8px 10px", fontSize: "11px", color: "#64748b" }}>
              ...
              <div style={{ color: "#334155" }}>트리거: {s.trigger}</div>
            </div>
          )}
        </div>
      ))}
      ...
      {log.length > 0 && (
        <div style={{ marginTop: "12px" }}>
          ...
          {log.map((d) => (
            ...
            >
              <div style={{ color: "#4f46e5", fontWeight: 700, marginBottom: "3px" }}>{d.topic}</div>
  ...
  return (
    <div>
      <div style={{ marginBottom: "14px" }}>
        ...
        <div style={{ fontSize: "11px", color: "#475569", marginTop: "3px", lineHeight: 1.6 }}>
